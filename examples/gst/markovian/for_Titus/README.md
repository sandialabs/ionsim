...
3) Include a python module of gate models (e.g. in gate_models.py) that map an input state to an output state. Specify which gates correspond to which gate models.   
