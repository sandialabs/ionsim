...
def main():
    ...
    gate_names = ['Gxpi2:0', 'Gxpi2:1', 'Gypi2:0', 'Gypi2:1', 'MS:0:1']
    gates = [] 
    qubit_indices = [0, 1] # index of each qubit  
    ...
    if Path(circuit_design_file).exists():
        ...
        germs = [[Gxpi2_q0], [Gxpi2_q1], [Gypi2_q0], [Gypi2_q1], [MS_gate], [Gxpi2_q1, MS_gate, Gxpi2_q0], [Gypi2_q1, MS_gate, MS_gate, Gypi2_q0]] 
        gst_circuit_planner = ism.GSTCircuitPlanner(gate_names, qubit_indices, germ_powers = powers, germs = germs, long_sequence_GST = False)
    ...
    gate_mappings = { Gxpi2_q0 : X_pi2_q0(0.01, 0.), Gxpi2_q1 : X_pi2_q1(0.02, 0.), Gypi2_q0 : Y_pi2_q0(0.005), Gypi2_q1 : Y_pi2_q1(0.005), MS_gate : MS_pm(0.02, 0.001)} 
    ...
    for N in N_counts:
        ...
        for circuit in gst_circuits:
            ...
            for gate in circuit.expanded_gates:
                ...
                rho = rho.propagate_using_process_matrix(gate_mappings[gate])
