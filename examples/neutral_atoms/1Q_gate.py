...
num_spins = 1 # single qubit for now 
...
## TODO: extract nuclear magnetic moment from qubit DOF. This should be parsed 
def compute_qubit_frequency(B_field: float, Zeeman_prefactor: float) -> float:
  ''' Nuclear qubit frequency defined via the linear Zeeman shift. '''
  ...
  omega_qubit = B_field * Zeeman_prefactor
